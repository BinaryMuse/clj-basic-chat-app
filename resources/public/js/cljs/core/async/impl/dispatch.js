...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13038 = 0;while(true){
var m_13039 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13039 == null))
{} else
{m_13039.call(null);
if((count_13038 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13040 = (count_13038 + 1);
count_13038 = G__13040;
continue;
}
} else
{}
